...
public class Loader {
	...
	public void cleanUp() {
		...
		System.out.println("INFO: VAOS deleted");
		for(int vbo : vbos) {
			GL15.glDeleteBuffers(vbo);
		}
		System.out.println("INFO: VBOS deleted");
		for(int texture : textures) {
			GL11.glDeleteTextures(texture);
		}
		System.out.println("INFO: Textures deleted");
	}
	...
	/**
	 * Converts data from a float array to a usable FloatBUffer
	 * @param data Data to convert
	 * @return The converted data as FloatBuffer
	 */
	...
	//TEXTURE LOAING
	public Texture loadTexture(String path, String fileName) {
